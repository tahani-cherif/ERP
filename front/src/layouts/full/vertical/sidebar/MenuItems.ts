...
const Menuitems = () => {
  ...
  const MenuItems: MenuitemsType[] = [
    ...
    },
    {
      ...
      title: 'Clients',
      icon: IconUsers,
      href: '/dashboards/clients',
      role: 'client',
    },
    {
      id: uniqueId(),
      title: t('fournisseur') || 'Supplier',
    ...
    {
      id: uniqueId(),
      title: t('produit') || 'Stock/Inventory',
    ...
    {
      id: uniqueId(),
      title: t('credit') || 'Credit tracking',
      icon: IconTicket,
    ...
    {
      id: uniqueId(),
      title: t('caisse') || 'Cash register tracking',
      icon: IconCash,
    ...
    {
      id: uniqueId(),
      title: t('recouverement') || 'Collection follow-up',
    ...
    {
      id: uniqueId(),
      title: t('deponse') || 'Expense tracking',
    ...
    {
      id: uniqueId(),
      title: t('juridique') || 'Legal follow-up',
      icon: IconNotes,
