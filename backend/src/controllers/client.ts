...
const getClients = asyncHandler(async (req: any, res: Response) => {
  ...
  const clients = await clientModel.find({admin:userId});
...
// @access  Private
const getClient = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
  const { id } = req.params;
...
// @access  Private
const updateClient = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
  const { id } = req.params;
...
// @access  Private
const deleteClient = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
  const { id } = req.params;
