...
// @access  Private
const updateBanque = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    const { id } = req.params;
...
// @access  Private
const deleteBanque = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    const { id } = req.params;
...
export { getBanques, getBanque, createBanque, updateBanque, deleteBanque };
