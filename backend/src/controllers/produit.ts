...
const getProduits = asyncHandler(async (req: any, res: Response) => {
  ...
  const produits = await produitModel.find({admin:userId});
...
// @access  Private
const getProduit = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
  const { id } = req.params;
...
// @access  Private
const updateProduit = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
  const { id } = req.params;
...
// @access  Private
const deleteProduit = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
  const { id } = req.params;
